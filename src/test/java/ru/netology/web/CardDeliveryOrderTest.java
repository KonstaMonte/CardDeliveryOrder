...
public class CardDeliveryOrderTest {
    ...
    public void shouldCardDeliveryOrder() {
        ...
        $("[data-test-id=name] input").setValue("Алексеев-Константин");
        $("[data-test-id=phone] input").val("+79260000000");
    ...
    public void shouldCardDeliveryOrderInvalidName() {
        ...
        $("[data-test-id=city] input").val("Москва");
        $("[data-test-id=date] input").val(date);
        $("[data-test-id=name] input").setValue("Alexeev-Konstantin");
        $("[data-test-id=phone] input").val("+79260000000");
        $("[data-test-id=agreement]").click();
        $x("//*[text()='Забронировать']").click();
    ...
    public void shouldCardDeliveryOrderInvalidCity() {
        String date = plusDays(3);
        $("[data-test-id=city] input").val("Сургут");
        $("[data-test-id=date] input").val(date);
        $("[data-test-id=name] input").setValue("Алексеев-Артур");
        $("[data-test-id=phone] input").val("+79260001111");
        $("[data-test-id=agreement]").click();
        $x("//*[text()='Забронировать']").click();
